...
con=sqlcon.connect(host="localhost",user="root",password="new_password")
#connection to mysql
cur=con.cursor()
...
def register():
    ...
    l6=Label(root1,text="BLOOD TYPE")
    l6.place(x=10,y=330)
...
def get_apoint():
    ...
    if len(a)==0:
        ...
        for i in dat:
            ...
            bg=Label(root3,text='BLOOD TYPE:-')
            bg.place(x=50,y=140)
        ...
        L.place(x=50,y=220)
        L1=Label(root3,text="1.Orthopaedic")
        L1.place(x=50,y=250)
        ...
        L6.place(x=50,y=350)
        L7=Label(root3,text='your choice')
        ...
        L8=Label(root3,text=('Enter time in 24 hours')).place(x=48,y=430)
...
def lst_doc():
    ...
    l=["Dr.Nandhu S","Dr.Navneeth M","Dr. Khan","Dr.Saji K","Dr.Rojin CP","Dr.Parthiv A","Dr.Leo T","Dr.Irfan","Dr.John",'Dr.Nalini S','Dr.Dan Abraham',
       'Dr.Anna E','Dr.Shajahan S',"Dr.Akilesh Ram"]
    m=["Orthopaedic","Orthopaedic","Nephrologist","Nephrologist","Gynaecologist","Gynaecologist","Physician","Physician","Neurologist",
...
def ser_avail():
    ...
    frame.pack()
    l1=Label(root5,text='SERVICES')
    l1.place(x=20,y=10)
    f=["ULTRASOUND","X-RAY","CT Scan","MRI","DIALYSIS","ECG","CHEMIST","LAB"]
    count1=20
    for i in f:
       count1=count1+20
    ...
    l5=Label(root5,text='To avail any of these please contact on our no.:- 701622432,7034226182')
    l5.place(x=20,y=240)
...
def modify():
    ...
    if len(a)==0:
      ...
      l4.place(x=50,y=240)
      l5=Label(root6,text='3.SEX')
      l5.place(x=50,y=260)
      l6=Label(root6,text='4.PHONE')
      l6.place(x=50,y=280)
      l7=Label(root6,text='5.BLOOD TYPE')
      l7.place(x=50,y=300)
      ...
      for i in dat:
            ...
            bg=Label(root6,text='BLOOD TYPE:-')
            bg.place(x=50,y=160)
      ...
      L1.place(x=50,y=50)
      L2=Label(root6,text='Correction')
      L2.place(x=50,y=360)
...
def modify():
    ...
    if len(a) == 0:
        ...
        for i in dat:
            ...
            age1 = Label(root6, text=i[2])
            age1.place(x=150, y=100)
            sex = Label(root6, text='SEX:-')
            sex.place(x=50, y=120)
            sex1 = Label(root6, text=i[3])
            sex1.place(x=150, y=120)
            phone = Label(root6, text='PHONE:-')
            phone.place(x=50, y=140)
            phone1 = Label(root6, text=i[4])
...
root=Tk()
label=Label(root,text="Marine Care Hospital",font="arial 40 bold",bg='red')
